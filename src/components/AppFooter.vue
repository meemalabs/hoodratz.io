    ...
    <div class="container mx-auto">
        ...
        <div class="py-8 px-3 text-sm md:grid md:grid-cols-3 md:gap-4">
            <div>
                ...
                <p class="my-4 text-center md:text-left leading-6 text-sm md:text-xs lg:text-base">
                ...
                <div class="text-center md:text-left text-gray-4">
            ...
            <div class="col-span-2 hidden md:block">
                <div class="grid grid-cols-4 mt-6">
                    ...
                    <div>
                        ...
                        <ul>
                            <li class="my-2"><router-link class="hover:text-white" to="/privacy-policy">Privacy policy</router-link></li>
                            <li class="my-2"><a class="cursor-not-allowed" href="#">Cookie policy</a></li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <div class="flex justify-center mb-4">
                            <ul class="grid grid-cols-3 gap-1 lg:gap-3 xl:gap-4">
                                <li class="rounded-full border flex items-center justify-center border-gray-5 md:w-10 md:h-10 lg:w-12 lg:h-12">
