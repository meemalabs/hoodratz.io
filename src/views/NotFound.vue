...
<div class="bg-white">
  <main class="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
    <div class="max-w-xl mx-auto py-16 sm:py-24">
      <div class="text-center">
        <h1 class="mt-2 text-4xl font-extrabold tracking-tight sm:text-5xl text-pink-3">This page does not exist.</h1>
        ...
        <ul role="list" class="mt-4 border-t border-b border-gray-200 divide-y divide-gray-200">
          <li class="relative py-6 flex items-start space-x-4">
            ...
            <div class="min-w-0 flex-1">
              ...
              <p class="text-base text-gray-500">Know about the Hoodratz Story!</p>
            </div>
          ...
          <li class="relative py-6 flex items-start space-x-4">
            ...
            <div class="min-w-0 flex-1">
              <h3 class="text-base font-medium text-gray-900">
                <span class="rounded-sm focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-indigo-500">
                  <a href="/roadmap" class="focus:outline-none">
                    <span class="absolute inset-0" aria-hidden="true"></span>
                    Roadmap
                  </a>
                </span>
              </h3>
              <p class="text-base text-gray-500">Find out what's the plan!</p>
            </div>
            <div class="flex-shrink-0 self-center">
  ...
  <footer class="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8">
    <div class="border-t border-gray-200 py-12 text-center md:flex md:justify-between">
      <p class="text-base text-gray-400">&copy; 2021 Hoodratz Inc. All right reserved</p>
      <div class="mt-6 flex justify-center space-x-8 md:mt-0">
        <a href="#" class="inline-flex text-gray-400 hover:text-gray-500">
          <span class="sr-only">Facebook</span>
          <svg class="h-6 w-6 text-pink-2" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
