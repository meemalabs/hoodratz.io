      ...
      <div class="relative mx-auto md:mt-32">
        <div class="mx-auto md:w-2/3">
          ...
          <div class="relative w-full my-4">
            <div class="w-full">
              <img src="/images/rarities-bg.png" alt="About" />
            </div>
            <div
          ...
          <div class="relative mx-4 text-center -top-24 lg:-top-32 xl:-top-36">
            <div class="mb-20">
              ...
              >
                How rare are the ratz?
              </h2>
              <p class="leading-7 font-sora">
                Check out our common, rare, and mythic attributes!
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="relative mx-auto md:mb-32">
        ...
        <div class="relative mx-auto">
          <div class="max-w-5xl mx-auto mt-12">
            <img src="/images/rarity-chart.png" alt="Rarity Chart" />
          </div>
        </div>
